...
const Navbar = () => {
    return (
        <>
            {/* This div is not needed for the navbar to function correctly */}
            <div className='relative z-1000 w-full h-20 bg-transparent'></div>
            <div className='fixed left-0 top-0 z-50 flex items-center justify-between py-5 px-14 w-full backdrop-blur-sm text-gray-200 transition duration-500 ease-in-out'>
                ...
                <div className="flex gap-14 font transition duration-500 ease-in-out">
